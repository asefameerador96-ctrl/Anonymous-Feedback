...
export default function Respond() {
  ...
  // Pick up an invite code handed out as a link (e.g. /respond?code=abc123),
  // prefill it, scrub it from the address bar/history, and validate.
  useEffect(() => {
  ...
  return (
    <main className="min-h-screen flex flex-col">
      <header className="px-8 py-6 flex justify-between items-center">
        <a href="/" className="serif text-xl">
          Anonvey
        </a>
        <span className="mono text-xs uppercase tracking-widest text-sage">
          Truly Anonymous
        </span>
      </header>
        ...
        <div className="max-w-xl w-full">
          ...
          >
            ...
            <ul className="text-sm leading-relaxed space-y-2 opacity-80">
              ...
              <li>
                — We don&apos;t log your IP, your browser, or the time you
                submitted beyond the day.
              </li>
              <li>
                — Results are only shown to leadership in groups above a set
                threshold.
              </li>
              <li>
      ...
      <footer className="px-8 py-6 mono text-xs opacity-40 text-center">
        Powered by Anonvey · No tracking · No analytics
      </footer>
    </main>
  );
}
